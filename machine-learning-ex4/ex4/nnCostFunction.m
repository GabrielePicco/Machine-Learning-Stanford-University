...
errorMatrix = (-yRef .* log(layer3)) - ((1 .- yRef) .* log(1 .- layer3));
sumOfErrors = sum(sum(errorMatrix));
...
Theta2_grad = (Theta2_grad .+ (delta_3' * layer2)) ./ m;
Theta1_grad = (Theta1_grad .+ (delta_2' * X)) ./ m;
